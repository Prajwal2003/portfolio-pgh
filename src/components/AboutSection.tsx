      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {[
            ...
            <div 
              key={index}
              className="group p-8 rounded-3xl border border-white/5 hover:border-white/20 hover:bg-white/5 transition-all duration-700 hover:-translate-y-3 hover:shadow-2xl hover:shadow-white/5"
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed text-center font-light group-hover:text-gray-300 transition-colors duration-300">
                ...
                {item.description.includes('scalable applications') && (
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300"> scalable applications</span>
                )}
                {item.description.split('scalable applications')[1]}
                {item.description.includes('exceptional user experience') && (
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300"> exceptional user experience</span>
                )}
                {item.description.includes('excellent performance') && (
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300"> excellent performance </span>
                )}
              </p>
            </div>
          ))}
